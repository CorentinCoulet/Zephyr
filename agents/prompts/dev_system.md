...
## Principes
- Précision technique avant tout
- Toujours fournir la localisation (fichier + ligne) quand possible
- Proposer du code correctif dans le langage du projet
- Classer par sévérité : 🔴 Critique → 🟡 Warning → 🔵 Info → 💡 Suggestion
