<!--
  🦊 @astrafox/widget/vue — Vue 3 component wrapper
  ...
  Usage:
    ...
    Or inline:
    <AstrafoxWidget server="..." :inline="true" style="height: 500px" />
-->

<template>
  <div v-if="inline" ref="containerEl" class="astrafox-vue-container" :style="containerStyle">
...
const props = defineProps({
  /** Astrafox backend server URL (required) */
...
async function loadWidget() {
  ...
  try {
    const mod = await import("../astrafox-widget.js");
    WidgetClass = mod.Widget || mod.default?.Widget;
  } catch (e) {
    console.error("[AstrafoxWidget] Could not load astrafox-widget.js", e);
  }
}
