 ...
 *
 * Usage:
 *   <script src="https://your-astrafox-server/sdk/astrafox-widget.js"></script>
 *   <script>
 *     AstrafoxWidget.init({
 ...
 *   AstrafoxWidget.init({ server: '...', persona: 'spirit' });
 */
...
(function (root, factory) {
    ...
    mascot: {
      svg: (accent) => `
        <svg viewBox="0 0 64 64" width="100%" height="100%">
          ...
          <image href="${ASTRAFOX_LOGO}" x="6" y="6" width="52" height="52" style="border-radius:50%"/>
        </svg>`,
    },
    spirit: {
      svg: (accent) => `
        <svg viewBox="0 0 64 64" width="100%" height="100%">
          ...
          <image href="${ASTRAFOX_LOGO}" x="8" y="8" width="48" height="48" opacity="0.9"/>
        </svg>`,
    },
    minimal: {
      svg: (accent) => `
        <svg viewBox="0 0 64 64" width="100%" height="100%">
          ...
          <image href="${ASTRAFOX_LOGO}" x="8" y="8" width="48" height="48"/>
        </svg>`,
    },
    futuristic: {
      svg: (accent) => `
        <svg viewBox="0 0 64 64" width="100%" height="100%">
          ...
          <image href="${ASTRAFOX_LOGO}" x="10" y="10" width="44" height="44"/>
        </svg>`,
    },
  };
  ...
  class Widget {
    ...
    _avatarSVG() {
      ...
      if (PERSONAS[persona]) {
        return PERSONAS[persona].svg(accent);
      }
      // Custom URL — use img
      return `<img src="${persona}" style="width:100%;height:100%;object-fit:contain;" alt="Astrafox"/>`;
    }
    ...
    _renderHTML() {
      ...
      return `
        <button class="kw-trigger ${sizeClass}" aria-label="Astrafox Assistant">
        ...
        <div class="kw-panel ${this.isOpen ? "kw-visible" : ""}">
          <div class="kw-header">
            ...
            <div class="kw-header-info">
              <div class="kw-header-title">Astrafox</div>
    ...
    _connectWS() {
      if (!this.config.server) {
        console.warn("[AstrafoxWidget] No server URL configured.");
        return;
      }
